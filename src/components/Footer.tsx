    ...
    <footer className="bg-black text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-2xl font-bold mb-4 text-pink-400">Rosangêla Rocha</h3>
            <p className="text-gray-300 mb-4">
              Salão de beleza especializado em transformar seu visual com carinho e profissionalismo.
            </p>
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/rosangelarochamakeup?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="text-gray-300 hover:text-pink-400 transition-colors">
                <Instagram size={20} />
              </a>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-300 flex items-center justify-center">
            ...
            <Heart className="mx-1 text-pink-400" size={16} /> 
            para você.
          </p>
        </div>
      </div>
