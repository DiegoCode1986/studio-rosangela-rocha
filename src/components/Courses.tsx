...
const Courses = () => {
  ...
  return (
    <section id="cursos" className="py-20 bg-gradient-to-br from-pink-50 to-rose-50">
      <div ref={ref} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between mb-4 text-sm text-gray-500">
                    ...
                    <div className="flex items-center">
                      <Users size={16} className="mr-1 text-pink-500" />
                  ...
                  <button className="w-full bg-gradient-to-r from-pink-600 to-rose-600 hover:from-pink-700 hover:to-rose-700 text-white py-3 px-4 rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center">
        ...
        <div className={`mt-16 text-center transition-all duration-1000 delay-500 ${
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg">
            ...
            <button className="bg-gradient-to-r from-pink-600 to-rose-600 hover:from-pink-700 hover:to-rose-700 text-white px-8 py-3 rounded-lg transition-all duration-300 transform hover:scale-105">
